...
% data sets
par.train = 1; % fraction of trials (just using cross-val here)
...
for i = 1:numel(xs)
    ...
    b(i).FaceColor = [143, 49, 139] ./ 255; % 143, 49, 139
    b(i).EdgeColor = 'none';
    % b(i).FaceAlpha = 0.5;
    % b(i).BarWidth = 0.7;
    vs(i) = scatter(xs(i)*ones(numel(dat),1),dat,30,'MarkerFaceColor','k',...
